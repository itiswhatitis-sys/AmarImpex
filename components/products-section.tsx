export default function ProductsSection() {
  return (
    <section className="w-full py-16 md:py-24 relative overflow-hidden">
      {/* Colorful background image (bottom layer) */}
      <div className="absolute inset-0 z-0">
        <img
          src="/images/colored-roofing-sheets.png"
          alt=""
      ...
      {/* Blurred dark overlay image (middle layer) */}
      <div className="absolute inset-0 z-5">
        <img src="/images/products-bg-blur.png" alt="" className="w-full h-full object-cover" aria-hidden="true" />
      </div>
