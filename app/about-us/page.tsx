...
export default function AboutUsPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col w-full overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12 md:gap-y-16">
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 mb-4">
                <svg viewBox="0 0 24 24" fill="none" stroke="url(#gradient1)" className="w-full h-full">
                  <defs>
              ...
              <h3 
                className="text-xl font-normal mb-2 inline-block"
                style={{ 
                  fontFamily: "Stolzl, sans-serif",
                  background: "linear-gradient(to right, #E31E25, #8B87FF)",
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 mb-4">
                <svg viewBox="0 0 24 24" fill="none" stroke="url(#gradient2)" className="w-full h-full">
                  <defs>
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 mb-4">
                <svg viewBox="0 0 24 24" fill="none" stroke="url(#gradient3)" className="w-full h-full">
                  <defs>
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 mb-4">
                <svg viewBox="0 0 24 24" fill="none" stroke="url(#gradient4)" className="w-full h-full">
                  <defs>
      ...
      <section className="w-full bg-[#333333] text-white relative py-12 md:py-0">
      ...
      <section className="w-full py-16 md:py-24 bg-white text-[#000000]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16">
            ...
            <div className="flex flex-col items-center md:items-start">
              <div className="w-16 h-16 mb-4">
                <svg viewBox="0 0 24 24" fill="none" stroke="url(#gradient5)" className="w-full h-full">
                  <defs>
            ...
            <div className="flex flex-col items-center md:items-start">
              <div className="w-16 h-16 mb-4">
                <svg viewBox="0 0 24 24" fill="none" stroke="url(#gradient6)" className="w-full h-full">
                  <defs>
            ...
            <div className="flex flex-col items-center md:items-start">
              <div className="w-16 h-16 mb-4">
                <svg viewBox="0 0 24 24" fill="none" stroke="url(#gradient7)" className="w-full h-full">
                  <defs>
            ...
            <div className="flex flex-col items-center md:items-start">
              <div className="w-16 h-16 mb-4">
                <svg viewBox="0 0 24 24" fill="none" stroke="url(#gradient8)" className="w-full h-full">
                  <defs>
        ...
        {/* Divider */}
        <div className="pt-20">
          <img src="/images/divider-line.png" alt="Divider" className="max-w-5xl mx-auto h-auto w-full" />
        </div>
      </section>
